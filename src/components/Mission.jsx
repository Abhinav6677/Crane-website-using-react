...
const Mission = () => {
  return (
    <section className="flex flex-col items-center py-16  bg-[#5b5d49] md:px-10 lg:px-20">
      <h1 className="text-[#4e4d4d] text-3xl md:text-4xl lg:text-5xl mb-8  font-bold ">
        Our Mission
      </h1>
